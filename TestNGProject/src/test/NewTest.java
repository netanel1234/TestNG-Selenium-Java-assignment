...
public class NewTest {
	...
	public void testValidate_Years_Of_Experience_For_QA_Automation_Position() {
		...
		double years = Double.parseDouble(driver.findElement(By.xpath(requirementXPath)).getText().split(" ")[0].replace("+", ""));
	...
	public void testFive_Icons_And_Valide_Types() {
		...
		// Creating a Map that maps name of social media to it's id attribute
		...
		// Checking number of icon that appear
		try {
